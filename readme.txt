...
To start using the "Connect Pagalo and WooCommerce", first create an account at [Pagalo.gt](https://pagalo.gt/). They will provide you with your account "IdenEmpresa", "Token", "Private key" and "Public Key".
